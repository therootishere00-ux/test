        ...
        {!chatStarted ? (
          <div className="flex h-full flex-col items-center justify-center">
            ...
            <div className="w-full max-w-[600px] px-8 mb-12 flex flex-col items-start">
              <img src="/icons/logo.svg" alt="Logo" className="w-10 h-10 mb-8" />
            ...
            <div className="w-full max-w-[600px] px-6">
              <div className="relative flex w-full flex-col bg-[#2D2C2A] rounded-[20px] border border-white/5 transition-all duration-500 focus-shimmer">
                <div className="flex flex-col p-3"> 
                  <textarea
                    ref={textareaRef}
                    value={message}
                    onChange={(e) => setMessage(e.target.value)}
                    placeholder="Спросить о чем-нибудь..."
                  ...
                  <div className="flex items-center justify-end mt-4">
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-[10px] bg-[#5FA86D] transition-all hover:bg-[#6FBD7E] disabled:opacity-10 active:scale-90"
                    >
                      <img 
                        src="/icons/send.svg" 
                        className="w-5 h-5" 
