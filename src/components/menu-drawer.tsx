      ...
      {open && (
        <>
          ...
          <motion.aside
            ...
            className="fixed left-0 top-0 z-[70] h-dvh w-[80%] max-w-[320px] bg-[#252422] flex flex-col shadow-2xl border-r border-white/5"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 pt-8 pb-4">
              <div className="flex items-center gap-2.5">
                <img src="/icons/logo.svg" alt="Logo" className="w-6 h-6 opacity-90" />
            ...
            <div className="w-full bg-[#2D2C2A] px-5 py-4 flex items-center justify-between">
              ...
              <button className="p-2 -mr-2 active:scale-90 transition-transform">
                <img src="/icons/dots.svg" alt="Options" className="w-5 h-5 opacity-60" />
              </button>
            </div>
          </motion.aside>
        </>
